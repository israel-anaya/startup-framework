 ...
 */
@StartupController
public abstract class CRUDControllerChildBase<DTO extends DataTransferObjectChild, F extends CRUDFeignChild<DTO>>
	...
	protected CRUDControllerChildBase(F feign) {
	...
	public ResponseEntity<DTO> createItem(String parentId, DTO item) {
		DTO newItem = feign.createItem(item, parentId);
	...
	public ResponseEntity<DTO> updateItem(String parentId, DTO item) {
		...
		DTO updatedItem = feign.updateItem(item, parentId);
