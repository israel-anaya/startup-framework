 ...
 */
public abstract class EntityChildServiceBase<R extends EntityRepository<E>, E extends Entity>
		extends EntityServiceBase<R, E> implements EntityChildService<E> {

	@Getter(value = AccessLevel.PROTECTED)
	private boolean isAggregated;

	protected EntityChildServiceBase(final R repository, boolean isAggregated) {
		super(repository);
