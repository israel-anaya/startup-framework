...
public interface CRUDChildService<DTO extends Identifiable<String>> {
	...
	abstract Mono<DTO> save(String parentId, String childId, DTO dto);

	abstract Mono<DTO> findById(String parentId, String childId);

	abstract Flux<DTO> findAll(String parentId);
