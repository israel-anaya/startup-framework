...
public abstract class CRUDChildControllerBase<DTO extends DataTransferObjectChild, S extends CRUDChildService<DTO>>
	...
	@Override
	public Mono<ResponseEntity<DTO>> createItem(String parentId, DTO item) {
		DTO newItem = service.save(parentId, item.getChildId(), item);
		return new ResponseEntity<>(newItem, HttpStatus.CREATED);
	}

	@Override
	public Mono<ResponseEntity<DTO>> updateItem(String parentId, DTO item) {
	...
	@Override
	public Mono<ResponseEntity<DTO>> deleteItem(String parentId, String childId) {
