 ...
 */
public abstract class EntityServiceAdapterChild<DTO extends EntityChildDTO, E extends Entity, S extends EntityServiceChild<E>>
		extends EntityServiceAdapterBase<DTO, E, S> implements CRUDAdapterChild<DTO> {

	protected EntityServiceAdapterChild(final S service, DataConverter<DTO, E> dataConverter) {
